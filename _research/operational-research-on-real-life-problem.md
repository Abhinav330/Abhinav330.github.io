...
<center>Table 1: The general form of a simplex tableau (Banciu (2011))</center>
...
Figure 5:  Some of the items considered in the model with their ratings and weights. </center>
...
Figure 6:  User input section of the model with drop-down options for trip specifics. </center>
...
Figure 8: Microsoft Excel solver parameters dialog box.</center>
...
Figure 9: Model Output.</center>
 
<center>
![fig6](/images/research/r3-6.png)
Figure 10: Mandatory Items selection</center>
...
Figure 11: Custom model performance Matrices</center>
